...
If the app install job is successful, you can skip ahead to <<_step_3_test_the_pet_application,Step 3 - Test the Pet Application>>.
____
...
+
[%nowrap,source,bash,role=execute]
----
...
----
+
Type Ctrl-C to quit the `tail -f` command.
