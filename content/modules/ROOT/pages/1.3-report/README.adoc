...
In link:../1.1-setup/README.html#_step_2_using_the_terminal_session[Exercise 1.1, Step 2], we learned how to open an ssh session to one of our pet app servers.
